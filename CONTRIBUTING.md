# How to contribute to Poc notif?
...
- What is the version of the Poc notif app?
...
```
$ git clone github.com/crash/poc-notif.git
$ cd poc-notif
$ git remote add fork git://github.com/yourusername/poc-notif.git
```
...
Go to https://github.com/yourusername/poc-notif and select your branch. Click the 'Pull Request' button and fill out the form.
...
The Poc notif is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/crash/poc-notif/issues/new
...
[localization]: https://github.com/crash/poc-notif/blob/master/README.md#localization
